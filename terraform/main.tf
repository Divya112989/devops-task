...
resource "azurerm_storage_account" "devops_task_sa" {
...
resource "azurerm_storage_container" "devops_task_sc" {
  name                  = "tfstate"
  storage_account_id    = azurerm_storage_account.devops_task_sa.id
  container_access_type = "private"
}

###########################################
# STEP 2: Actual Infra
# After backend is set, uncomment these
###########################################

# terraform {
#   backend "azurerm" {
#     resource_group_name  = "devops-task-rg"
#     storage_account_name = "tfstate<suffix>"   # <- copy from Step 1 output
...
#   admin_ssh_key {
#     username   = "azureuser"
#     public_key = file("C:/Users/divya/.ssh/id_rsa.pub")
#   }
